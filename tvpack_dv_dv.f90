...
& nbdirsmax0, nbdirsmax), r23dd(nbdirsmax0, nbdirsmax)
  ...
  DOUBLE PRECISION :: tvtdd(nbdirsmax0, nbdirsmax)
...
!
  ...
  DOUBLE PRECISION :: dhdd(nbdirsmax0, nbdirsmax), dkdd(nbdirsmax0, &
& nbdirsmax), rdd(nbdirsmax0, nbdirsmax)
...
& , bvtd(nbdirsmax)
  DOUBLE PRECISION :: orsdd(nbdirsmax0, nbdirsmax), hrkdd(nbdirsmax0, &
& nbdirsmax), krhdd(nbdirsmax0, nbdirsmax), bvtdd(nbdirsmax0, nbdirsmax)
...
& nbdirsmax), xnhkd(nbdirsmax), qhrkd(nbdirsmax), hknd(nbdirsmax), hpkd(&
& nbdirsmax), hkrnd(nbdirsmax)
  DOUBLE PRECISION :: gmphdd(nbdirsmax0, nbdirsmax), gmpkdd(nbdirsmax0, &
& nbdirsmax), xnkhdd(nbdirsmax0, nbdirsmax), xnhkdd(nbdirsmax0, &
& nbdirsmax), qhrkdd(nbdirsmax0, nbdirsmax), hkndd(nbdirsmax0, nbdirsmax&
& ), hpkdd(nbdirsmax0, nbdirsmax), hkrndd(nbdirsmax0, nbdirsmax)
...
& nbdirsmax), btpdhkd(nbdirsmax)
  DOUBLE PRECISION :: btnckhdd(nbdirsmax0, nbdirsmax), btnchkdd(&
& nbdirsmax0, nbdirsmax), btpdkhdd(nbdirsmax0, nbdirsmax), btpdhkdd(&
...
!
  ...
  DOUBLE PRECISION :: tdd(nbdirsmax0, nbdirsmax)
...
& nbdirsmax), ttd(nbdirsmax), tsd(nbdirsmax)
  DOUBLE PRECISION :: cssthedd(nbdirsmax0, nbdirsmax), snthedd(&
& nbdirsmax0, nbdirsmax), polyndd(nbdirsmax0, nbdirsmax), ttdd(&
& nbdirsmax0, nbdirsmax), tsdd(nbdirsmax0, nbdirsmax)
  PARAMETER (zro=0, one=1)
  INTRINSIC ACOS
  INTRINSIC ATAN
  INTRINSIC SQRT
...
& nbdirsmax), dd(nbdirsmax), rsd(nbdirsmax), xsd(nbdirsmax), bvnd0(&
& nbdirsmax)
  DOUBLE PRECISION :: asdd(nbdirsmax0, nbdirsmax), add(nbdirsmax0, &
& nbdirsmax), bdd(nbdirsmax0, nbdirsmax), cdd(nbdirsmax0, nbdirsmax), &
& ddd(nbdirsmax0, nbdirsmax), rsdd(nbdirsmax0, nbdirsmax), xsdd(&
& nbdirsmax0, nbdirsmax), bvnd0d(nbdirsmax0, nbdirsmax)
  DOUBLE PRECISION :: phid, sn, asr, h, k, bs, hs, hk
  DOUBLE PRECISION, DIMENSION(nbdirsmax0) :: snd0, asrd0, hd0, kd0, bsd0&
& , hsd0, hkd0
  DOUBLE PRECISION :: snd(nbdirsmax), asrd(nbdirsmax), hd(nbdirsmax), kd&
& (nbdirsmax), bsd(nbdirsmax), hsd(nbdirsmax), hkd(nbdirsmax)
  DOUBLE PRECISION :: sndd(nbdirsmax0, nbdirsmax), asrdd(nbdirsmax0, &
& nbdirsmax), hdd(nbdirsmax0, nbdirsmax), kdd(nbdirsmax0, nbdirsmax), &
& bsdd(nbdirsmax0, nbdirsmax), hsdd(nbdirsmax0, nbdirsmax), hkdd(&
& nbdirsmax0, nbdirsmax)
  SAVE x, w
  INTRINSIC ABS
  INTRINSIC ASIN
  ...
  DOUBLE PRECISION :: max1dd(nbdirsmax0, nbdirsmax)
  DOUBLE PRECISION :: arg1
  DOUBLE PRECISION, DIMENSION(nbdirsmax0) :: arg1d0
  DOUBLE PRECISION :: arg1d(nbdirsmax)
  DOUBLE PRECISION :: arg1dd(nbdirsmax0, nbdirsmax)
...
& nbdirsmax), td(nbdirsmax), xad(nbdirsmax), zd(nbdirsmax)
  DOUBLE PRECISION :: bmdd(nbdirsmax0, nbdirsmax), bdd(nbdirsmax0, &
& nbdirsmax), bpdd(nbdirsmax0, nbdirsmax), pdd(nbdirsmax0, nbdirsmax), &
& tdd(nbdirsmax0, nbdirsmax), xadd(nbdirsmax0, nbdirsmax), zdd(&
& nbdirsmax0, nbdirsmax)
  ...
  DOUBLE PRECISION :: abs0dd(nbdirsmax0, nbdirsmax)
  DOUBLE PRECISION :: arg1
  DOUBLE PRECISION, DIMENSION(nbdirsmax0) :: arg1d0
  DOUBLE PRECISION :: arg1d(nbdirsmax)
  DOUBLE PRECISION :: arg1dd(nbdirsmax0, nbdirsmax)
